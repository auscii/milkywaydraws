...
const getCommissions = async (doc) => {
    ...
    values.docs.forEach(v => {
        ...
        $('#financial-commission-lists').append('<tr><td class="text-center">'+dateTimeCreated+'</td><td class="text-center">'+commissionUserName+'</td><td class="text-center">'+commissionPaymentMethod+'</td><td class="text-center">'+commissionEmail+'</td><td class="text-center">'+commissionType+'</td><td class="text-center"><span style="'+statusColor+'">'+status+'</span></td><td class="text-center"><select class="form-control" id="financial-payment-status-selection" onchange="updateFinancialCommissionPayment(\''+docId+'\',\''+commissionType+'\')"><option disabled selected>--Select Payment Status--</option><option value="'+paid+'">'+paid+'</option><option value="'+unpaid+'">'+unpaid+'</option><option value="'+invoice+'">'+invoice+'</option></select></td></tr>');
        hideProgressModal();
